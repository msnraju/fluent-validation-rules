...
export interface IDateValidatorBuilder<T, TType> extends IMemberValidatorBuilder<T, TType>, IEqualityValidatorBuilder<T, TType>, ICompareValidatorBuilder<T, TType> {
}
