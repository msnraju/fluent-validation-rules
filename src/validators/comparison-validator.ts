...
export class ComparisonValidator<T, TType>
  implements IComparisonValidator<TType> {
  ...
  isLessThan(value: TType) {
    this.rule.message = () =>
      `${this.rule.member} should be less than ${value}.`;
  ...
  isLessThanOrEqualTo(value: TType) {
    this.rule.message = () =>
      `${this.rule.member} should be less than or equal to ${value}.`;
  ...
  isGreaterThan(value: TType) {
    this.rule.message = () =>
      `${this.rule.member} should be greater than ${value}.`;
  ...
  isGreaterThanOrEqualTo(value: TType) {
    this.rule.message = () =>
      `${this.rule.member} should be greater than or equal to ${value}.`;
  ...
  isBetween(from: TType, to: TType) {
    this.rule.message = () =>
      `${this.rule.member} should be between ${from} to ${to}.`;
